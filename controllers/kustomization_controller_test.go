...
func triggerReconcile(k8sClient client.Client, name types.NamespacedName) {
	k := &kustomizev1.Kustomization{}
	...
	k.Annotations[meta.ReconcileRequestAnnotation] = metav1.Now().String()
